...
gr_dsp_fir_ccf_fm_demod_sptr gr_make_dsp_fir_ccf_fm_demod (const std::vector<float> &taps, short scale_data, short decimation, short input_sig, short output_sig, short dsp_init_flag, short fir_id);
